...
//Incluimos librería sensor dht11
#include <DHT.h>
...
float leerHumedad(){
  // Leemos la humedad directamente de la librería
  float humedad = HT.readHumidity();
  
  // La librería devuelve float, lo convertimos a entero
  return humedad;
}
  
void mostrarDatosLCD(float t, float h){
